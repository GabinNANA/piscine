...
<div class="modal-header">
    <h4 class="modal-title" id="myModalLabel1">Ajouter un utilisateur</h4>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true"><i class="ft-x font-medium-2 text-bold-700"></i></span>
    </button>
</div>

<form action="parametre/utilisateur/ajouter" method="post">
        ...
        <div class="col-md-12 col-12">
            <div class="form-group mb-2">
                ...
                <select class="form-control select2" name="employe" >
                    ...
                    ?>
                        <option value="<?=$employe->id?>"><?=$employe->intitule?></option>
                    <?php
                        }
                    ?>
                </select>
        ...
        $(this).ajaxSubmit({
            ...
            success: function(data, statusText, xhr) {
                if (data.state == 'success') {
                    search();
                    toastr.success('Utilisateur créée avec succès.');
