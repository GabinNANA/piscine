    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-12">
            <div class="content-header">Utilisateurs</div>
            </div>
        </div>
        <section>
            <div class="row">
            <div class="col-12">
                ...
                <div class="card-content ">
                    <div class="card-body">
                    <?php if(checkPrivilege("add_utilisateur")){ ?>
...
$(document).ready(function(){
  search();
    ...
    $(document).on('click','.voir-row',function(){
      ...
      $.ajax({
              type: "POST",
              url: "parametre/utilisateur/detail",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                $('#modalAll .modal-content').html(data);
    ...
    $(document).on('click','.edit-row',function(){
      ...
      $.ajax({
              type: "POST",
              url: "parametre/utilisateur/update",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                $('#modalAll .modal-content').html(data);
    ...
    $(document).on('click','#delete',function(){
      ...
      $.ajax({
              type: "POST",
              url: "parametre/utilisateur/delete",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                search();
    ...
    function search()
    {
        $.ajax({
            type: "POST",
            url: "parametre/utilisateur/search",
            data: {},
            dataType: "text",
            success: function(data){
