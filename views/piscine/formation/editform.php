    ...
    <div class="modal-body form-row">
        ...
        <div class="col-md-12 col-12">
            <div class="form-group mb-2">
                ...
                <select type="text" class="form-control" name="employe">
                    ...
                    ?>
                        <option value="<?=$employe->id?>" <?=$abonnement->idclient==$employe->id ? 'selected':''?>><?=$employe->nom?></option>
                    <?php
                        }
                    ?>
                </select>
        ...
        <div class="col-md-12 col-12">
            <div class="form-group mb-2">
                ...
                <input type="number" class="form-control" name="nbre" value="<?=$abonnement->nbre?>"  placeholder="nombre de seances" required>
            </div>
        </div>
        <div class="col-md-12 col-12">
            <div class="form-group mb-2">
        ...
        $(this).ajaxSubmit({
            ...
            success: function(data, statusText, xhr) {
                if (data.state == 'success') {
                    search();
                    toastr.success('Formation modifié avec succès.');
