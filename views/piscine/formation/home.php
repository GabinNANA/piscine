    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-12">
            <div class="content-header">Formations</div>
            </div>
        </div>
        <section>
            <div class="row">
            <div class="col-12">
                ...
                <div class="card-content ">
                    <div class="card-body">
                        <?php if(checkPrivilege("add_formation")){ ?>
...
$(document).ready(function(){
  search();
    ...
    $(document).on('click','.voir-row',function(){
      $('#modalAll1').modal('show');
      var id = $(this).attr('data-id');
      $.ajax({
              type: "POST",
              url: "piscine/formation/detail",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                $('#modalAll1 .modal-content').html(data);
                $(".select2").select2();
                $(".add-rows").DataTable();
              }
            });
    ...
    $(document).on('click','#delete',function(){
      ...
      $.ajax({
              type: "POST",
              url: "piscine/formation/delete",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                search();
                toastr.success('formation supprimé avec succès.');
