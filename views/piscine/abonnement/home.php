    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-12">
            <div class="content-header">Abonnements</div>
            </div>
        </div>
        <section>
            <div class="row">
            <div class="col-12">
                ...
                <div class="card-content ">
                    <div class="card-body">
                        <?php if(checkPrivilege("add_abonnement")){ ?>
