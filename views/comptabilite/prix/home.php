    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-12">
            <div class="content-header">Configuration des prix</div>
            </div>
        </div>
        <section>
            <div class="row">
            <div class="col-12">
                ...
                <div class="card-header">
                    <h4 class="card-title">Liste des prix</h4>
                </div>
                <div class="card-content ">
                    <div class="card-body">
                        <?php if(checkPrivilege("add_prix")){ ?>
...
$(document).ready(function(){
  search();
    ...
    $(document).on('click','#delete',function(){
      ...
      $.ajax({
              type: "POST",
              url: "comptabilite/prix/delete",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                search();
                toastr.success('Prix supprimé avec succès.');
