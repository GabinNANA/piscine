    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-12">
            <div class="content-header">Caisses</div>
            </div>
        </div>
        <section>
            <div class="row">
            <div class="col-12">
                ...
                <div class="card-content ">
                    <div class="card-body">
                        <?php if(checkPrivilege("add_caisse")){ ?>
...
$(document).ready(function(){
  search();
    ...
    $(document).on('click','.voir-row',function(){
      ...
      $.ajax({
              type: "POST",
              url: "comptabilite/caisse/detail",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                $('#modalAll .modal-content').html(data);
    ...
    $(document).on('click','.edit-row',function(){
      ...
      $.ajax({
              type: "POST",
              url: "comptabilite/caisse/update",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                $('#modalAll .modal-content').html(data);
    ...
    $(document).on('click','#delete',function(){
      ...
      $.ajax({
              type: "POST",
              url: "comptabilite/caisse/delete",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                search();
                toastr.success('Caisse supprimé avec succès.');
    ...
    function search()
    {
        $.ajax({
            type: "POST",
            url: "comptabilite/caisse/search",
            data: {},
            dataType: "text",
            success: function(data){
