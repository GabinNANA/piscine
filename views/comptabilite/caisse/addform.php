...
<div class="modal-header">
    <h4 class="modal-title" id="myModalLabel1">Ajouter une caisse</h4>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true"><i class="ft-x font-medium-2 text-bold-700"></i></span>
    </button>
</div>

<form action="comptabilite/caisse/ajouter" method="post">
    <div class="modal-body form-row">
        ...
        <div class="col-md-12 col-12">
            <div class="form-group mb-2">
                ...
                <input type="number" class="form-control" name="solde" placeholder="Solde initial " required>
            </div>
        </div>
    </div>
        ...
        $(this).ajaxSubmit({
            ...
            success: function(data, statusText, xhr) {
                if (data.state == 'success') {
                    search();
                    toastr.success('Caisse créée avec succès.');
