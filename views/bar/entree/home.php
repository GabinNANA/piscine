    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-12">
            <div class="content-header">Entrées</div>
            </div>
        </div>
        <section>
            <div class="row">
...
$(document).ready(function(){
  search();
    ...
    $(document).on('click','#delete',function(){
      ...
      $.ajax({
              type: "POST",
              url: "bar/entree/delete",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                search();
                toastr.success('Entrée supprimé avec succès.');
