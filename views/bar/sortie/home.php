    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-12">
            <div class="content-header">Sorties</div>
            </div>
        </div>
        <section>
            <div class="row">
            <div class="col-12">
                ...
                <div class="card-content ">
                    <div class="card-body">
                        <?php if(checkPrivilege("add_sortie")){ ?>
...
$(document).ready(function(){
  search();
    ...
    $(document).on('click','#delete',function(){
      ...
      $.ajax({
              type: "POST",
              url: "bar/sortie/delete",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                search();
                toastr.success('Sortie supprimé avec succès.');
