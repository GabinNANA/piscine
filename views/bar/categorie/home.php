    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-12">
            <div class="content-header">Catégories</div>
            </div>
        </div>
        <section>
            <div class="row">
            <div class="col-12">
                ...
                <div class="card-content ">
                    <div class="card-body">
                        <?php if(checkPrivilege("add_categorie")){ ?>
...
$(document).ready(function(){
  search();
    ...
    $(document).on('click','#delete',function(){
      ...
      $.ajax({
              type: "POST",
              url: "bar/categorie/delete",
              data: {'id':id},
              dataType: "text",
              success: function(data){
                search();
                toastr.success('categorie supprimé avec succès.');
