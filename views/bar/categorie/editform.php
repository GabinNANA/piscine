...
<div class="modal-header">
    <h4 class="modal-title" id="myModalLabel1">Modifier une catégorie</h4>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true"><i class="ft-x font-medium-2 text-bold-700"></i></span>
    </button>
</div>
<?php
    $categorie=categorie::get($_REQUEST["id"]);
?>
<form action="bar/categorie/modifier" method="post">
    ...
    <div class="modal-body form-row">
        <div class="col-md-12 col-12">
            <div class="form-group mb-2">
                ...
                <input type="text" class="form-control" name="intitule"  value="<?=$categorie->intitule?>" placeholder="Nom" required>
            </div>
        </div>
    </div>
