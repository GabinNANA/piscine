...
<!-- Mirrored from coderthemes.com/adminox/default/page-logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 29 Sep 2019 22:56:47 GMT -->
<head>
        <meta charset="utf-8" />
                                ...
                                <div class="account-box">
                                    <div class="text-center account-logo-box">
                                        <h2 class="text-uppercase">
                                            <a href="index.html" class="text-success">
                                                <span><img src="assets/images/logo_dark.png" alt="" height="50" width="175"></span>
                                            </a>
                                        </h2>
                                    ...
                                    <div class="account-content">
                                        <div class="text-center m-b-20">
                                            ...
                                            <p class="text-muted font-13 m-t-10"> Vous vous êtes déconnecté avec succès. <a href="login" class="text-primary m-r-5"><b>Se connecter</b></a></p>
                                        </div>
