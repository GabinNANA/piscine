        ...
        <div class="col-12">
            ...
            <div class="card-content p-3">
                ...
                <div id="invoice-customer-details" class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <ul class="m-0 list-unstyled">
                            <li class="text-bold-800">M./Mme <?=Client::get($commande->idclient)->nom?></li>
                    ...
                    <div class="col-md-6 col-12 text-right">
                    <p><span class="text-muted">Date de facturation :</span> <?=format_dateDate(date("Y-m-d"))?></p>
                    <p><span class="text-muted">Pour :</span> Réservation</p>
                    <p class="m-0"><span class="text-muted">Date de reservation :</span> <?=format_dateDate($commande->date)?> | <?=$commande->heuredeb?> <?=strlen($commande->heurefin)>0 ? '-'.$commande->heurefin:''?></p>
                    </div>
                </div>
                ...
                <div id="invoice-items-details">
                    ...
                    <div class="col-md-6 col-12" style="float:right">
                        <p class="text-bold-700 mb-2 ml-4">Totaux </p>
                        ...
                        <table class="table">
                            ...
                            <tr class="text-bold-500">
                                <td>Total payé</td>
                                <td class="text-right"><?=format_money($commande->avance)?> FCFA</td>
                            </tr>
                            <tr>
                                <td>Reste</td>
                                <td class="danger text-right"><?=format_money($montant - $commande->avance)?> FCFA</td>
                            </tr>
                            </tbody>
                        </table>
                        </div>
