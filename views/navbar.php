<nav class="navbar navbar-expand-lg navbar-light header-navbar navbar-fixed">
          ...
          <div class="collapse navbar-collapse d-block" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="dropdown nav-item mr-1"><a class="nav-link dropdown-toggle user-dropdown d-flex align-items-end" id="dropdownBasic2" href="javascript:;" data-toggle="dropdown">
                  <div class="user d-md-flex d-none mr-2"><span class="text-right"><?=strtoupper($_SESSION["pseudo"])?></span>
                    <!-- <span class="text-right text-muted font-small-3">Available</span> -->
                  </div>
                  <!-- <img class="avatar" src="app-assets/img/portrait/small/avatar-s-1.png" alt="avatar" height="35" width="35"></a> -->
                <div class="dropdown-menu text-left dropdown-menu-right m-0 pb-0" aria-labelledby="dropdownBasic2"><a class="dropdown-item" href="app-chat.html">
                    ...
                    <div class="d-flex align-items-center"><i class="ft-edit mr-2"></i><span>Mon Profil</span></div></a><a class="dropdown-item" href="app-email.html">
                  ...
                  <div class="dropdown-divider"></div><a class="dropdown-item" href="logout">
                    <div class="d-flex align-items-center"><i class="ft-power mr-2"></i><span>Se deconnecter</span></div></a>
                </div>
              </li>
    ...
    <!-- Navbar (Header) Ends-->
    <div class="modal fade text-left" id="modalAll" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    ...
    <div class="modal fade text-left" id="modalAll1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    ...
    <div class="modal fade bs-example-modal-center" tabindex="-1" id="modaldelete" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="panel-title mt-0">Confirmation</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row m-t-20">
                        <div class="col-md-12 text-right">
                            <button id="delete" class="btn btn-success waves-effect waves-light"> Supprimer</button>
                            <button id="dialogCancel" class="btn btn-danger waves-effect" data-dismiss="modal">Annuler</button>
                        </div>
                    </div>
                </div>
            </div><!-- /.modal-content -->
    ...
    <div class="modal fade bs-example-modal-center" tabindex="-1" id="modaldelete1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="panel-title mt-0">Confirmation</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row m-t-20">
                        <div class="col-md-12 text-right">
                            <button id="delete1" class="btn btn-success waves-effect waves-light"> Supprimer</button>
                            <button id="dialogCancel" class="btn btn-danger waves-effect" data-dismiss="modal">Annuler</button>
                        </div>
                    </div>
                </div>
