...
<div class="modal-header">
    <h4 class="modal-title" id="myModalLabel1">Modifier un client</h4>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true"><i class="ft-x font-medium-2 text-bold-700"></i></span>
    </button>
</div>
<?php
    $client=client::get($_REQUEST["id"]);
?>
    ...
    <div class="modal-body form-row">
        <div class="col-md-12 col-12">
            <div class="form-group mb-2">
                ...
                <input type="text" class="form-control" name="nom"  value="<?=$client->nom?>" placeholder="Nom" required>
            </div>
        </div>
        <div class="col-md-12 col-12">
            <div class="form-group mb-2">
                <label for="basic-form-2">Téléphone </label>
                <input type="number" class="form-control" name="telephone" value="<?=$client->telephone?>" placeholder="Telephone" >
            </div>
        </div>
        <div class="col-md-12 col-12">
            <div class="form-group mb-2">
